...
#Decode entities:
#cat index.html | awk -f extr_editors_csv.awk | php -r 'while(($line=fgets(STDIN)) !== FALSE) echo html_entity_decode($line, ENT_QUOTES|ENT_HTML401);' >editors.csv
