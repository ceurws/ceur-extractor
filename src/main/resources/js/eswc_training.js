function processTrainingSet()
{
	...
	processPage('http://ceur-ws.org/Vol-1085/');
	processPage('http://ceur-ws.org/Vol-1081/');
	processPage('http://ceur-ws.org/Vol-1044/');
	...
	processPage('http://ceur-ws.org/Vol-994/');
	...
	processPage('http://ceur-ws.org/Vol-921/');
	...
	processPage('http://ceur-ws.org/Vol-551/');
	processPage('http://ceur-ws.org/Vol-538/');
	processPage('http://ceur-ws.org/Vol-540/');
	processPage('http://ceur-ws.org/Vol-477/');
	processPage('http://ceur-ws.org/Vol-431/');
	processPage('http://ceur-ws.org/Vol-369/');
	processPage('http://ceur-ws.org/Vol-353/');
	processPage('http://ceur-ws.org/Vol-315/');
	processPage('http://ceur-ws.org/Vol-304/');
	processPage('http://ceur-ws.org/Vol-250/');
	processPage('http://ceur-ws.org/Vol-225/');
	processPage('http://ceur-ws.org/Vol-232/');
	processPage('http://ceur-ws.org/Vol-189/');
	processPage('http://ceur-ws.org/Vol-147/');
	processPage('http://ceur-ws.org/Vol-104/');
	processPage('http://ceur-ws.org/Vol-81/');
	processPage('http://ceur-ws.org/Vol-53/');
	processPage('http://ceur-ws.org/Vol-49/');
	processPage('http://ceur-ws.org/Vol-44/');
	processPage('http://ceur-ws.org/Vol-33/');
	processPage('http://ceur-ws.org/Vol-22/');
	processPage('http://ceur-ws.org/Vol-11/');
	processPage('http://ceur-ws.org/Vol-5/');
