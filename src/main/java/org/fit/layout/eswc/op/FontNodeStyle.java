...
/**
 * A node style where the indentation and color is not compared.
 * 
 * @author burgetr
 */
public class FontNodeStyle
{
     ...
     * @param area
     */
    public FontNodeStyle(Area area)
    {
     ...
     * @param node
     */
    public FontNodeStyle(FontNodeStyle src)
    {
    ...
    public boolean equals(Object obj)
    {
        ...
        FontNodeStyle other = (FontNodeStyle) obj;
